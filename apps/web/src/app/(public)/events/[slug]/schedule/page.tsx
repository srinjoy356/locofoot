        ...
        {schedule.length === 0 ? (
          <Card className="border-slate-200 shadow-sm bg-slate-50/50">
            <CardContent className="flex flex-col items-center justify-center py-20 text-slate-400 space-y-4">
              ...
              <p className="text-xl font-semibold text-slate-500">The schedule is currently being finalized.</p>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {schedule.map((match) => (
              <Card key={match.id} className="border-slate-200/60 shadow-md hover:shadow-xl transition-all duration-300 bg-white group overflow-hidden relative">
                ...
                <CardHeader className="pb-3 bg-slate-50/50 border-b">
                  <div className="flex items-center justify-between text-sm font-semibold text-slate-600">
                    ...
                    <div className="flex items-center gap-1.5 text-slate-500 bg-slate-200/50 px-2.5 py-1 rounded-full text-xs">
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between">
                    <div className="flex flex-col items-center gap-2 w-5/12 text-center">
                      <div className="h-14 w-14 rounded-full bg-slate-100 flex items-center justify-center text-slate-400 text-xs font-bold border-2 border-white shadow-sm overflow-hidden">
                    ...
                    <div className="w-2/12 flex justify-center">
                      <div className="bg-slate-100 text-slate-400 text-xs font-black px-2 py-1 rounded-md">VS</div>
                    </div>
