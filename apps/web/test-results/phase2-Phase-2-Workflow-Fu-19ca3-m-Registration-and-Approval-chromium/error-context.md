...
Locator: locator('[data-testid="log-msg"]').filter({ hasText: /Created Event:/ })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid="log-msg"]').filter({ hasText: /Created Event:/ })
...
- main:
  ...
  - 'heading "Auth (Current: e2e_organizer@example.com)" [level=2]'
  - textbox "Email": e2e_organizer@example.com
  ...
  - text: "Logged in as e2e_organizer@example.com Error creating event: Unexpected token '<', \"<!DOCTYPE \"... is not valid JSON"
- alert
```
